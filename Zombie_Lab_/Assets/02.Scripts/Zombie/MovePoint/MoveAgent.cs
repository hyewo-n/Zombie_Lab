...
public class MoveAgent : MonoBehaviour
{
    ...
    // 좀비 캐릭터의 Transform 컴포넌트를 저장할 변수 
    ...
    void Start()
    {
        // 좀비의 Transform 컴포넌트 추출 후 변수에 저장 
   ...
   /* public float speed
    ...
    void Update()
    {
        ...
        // 이동 모드가 아닐 경우 이후 로직을 수행하지 않음
        if (!_patrolling) return;

        // NavMeshAgent가 이동하고 있고 목적기에 도착했는지 여부를 계산 
